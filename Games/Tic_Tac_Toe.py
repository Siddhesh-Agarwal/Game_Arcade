...
def Play_TicTacToe():
    def play():
        ...
        def check_win():
            ...
            if btn_11['text'] == 'X' and btn_12['text'] == 'X' and btn_13['text'] == 'X':
                ...
                winner = 'X'
                messagebox.showinfo("Game Over!", "Congrats!!! X has won the game.\nReset to continue.")
            if btn_11['text'] == 'X' and btn_21['text'] == 'X' and btn_31['text'] == 'X':
                btn_11.config(bg='red')
                btn_21.config(bg='red')
                btn_31.config(bg='red')
                winner = 'X'
            ...
            if btn_11['text'] == 'X' and btn_22['text'] == 'X' and btn_33['text'] == 'X':
                btn_11.config(bg='red')
                btn_22.config(bg='red')
                btn_33.config(bg='red')
                winner = 'X'
            ...
            if btn_11['text'] == 'O' and btn_12['text'] == 'O' and btn_13['text'] == 'O':
                ...
                winner = 'O'
                messagebox.showinfo("Game Over!", "Congrats!!! O has won the game.\nReset to continue.")
            if btn_11['text'] == 'O' and btn_21['text'] == 'O' and btn_31['text'] == 'O':
                btn_11.config(bg='red')
                btn_21.config(bg='red')
                btn_31.config(bg='red')
                winner = 'O'
            ...
            if btn_11['text'] == 'O' and btn_22['text'] == 'O' and btn_33['text'] == 'O':
                btn_11.config(bg='red')
                btn_22.config(bg='red')
                btn_33.config(bg='red')
                winner = 'O'
    ...
    def about():
        ...
        DRAW:
        If none of the players are successful in makingt a line of 3 cells vertically, horizontally or diagonally even
        after all the 9 cells have been used up, The game ends in a draw (neither players win/lose).
