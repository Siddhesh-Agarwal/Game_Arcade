...
def Play(game):
    ...
    btn1 = Button(
        subroot, **btn_params, text="Play Game", command=lambda: PlayGame(game)
    ).pack()  # Play Button
    btn2 = Button(
        subroot, **btn_params, text="Game Information", command=lambda: GameInfo(game)
    ).pack()  # Info Button
    btn3 = Button(
        subroot, **btn_params, text="Back to Main Menu", command=lambda: Back(subroot)
    ).pack()  # Back button
...
def main():
    ...
    btn1 = Button(
        mainroot, **btn_params, text="Ping Pong", command=lambda: Play("Ping Pong")
    ).pack()
    btn2 = Button(
        mainroot, **btn_params, text="Snake Game", command=lambda: Play("Snake Game")
    ).pack()
    btn3 = Button(
        mainroot,
        **btn_params,
        text="Space Battle",
        command=lambda: Play("Space Battle")
    ).pack()
    btn4 = Button(
        mainroot, **btn_params, text="Tic Tac Toe", command=lambda: Play("Tic Tac Toe")
    ).pack()
